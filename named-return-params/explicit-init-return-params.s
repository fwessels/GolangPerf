"".NamedReturnParamsExplicit t=1 size=67 args=0x40 locals=0x0
	0x0000 00000 (explicit-init-return-params.go:10)	TEXT	"".NamedReturnParamsExplicit(SB), $0-64
	0x0000 00000 (explicit-init-return-params.go:10)	NOP
	0x0000 00000 (explicit-init-return-params.go:10)	NOP
	0x0000 00000 (explicit-init-return-params.go:10)	FUNCDATA	$0, gclocals·895d0569a38a56443b84805daa09d838(SB)
	0x0000 00000 (explicit-init-return-params.go:10)	FUNCDATA	$1, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x0000 00000 (explicit-init-return-params.go:11)	MOVQ	$0, "".oi+16(FP)
	0x0009 00009 (explicit-init-return-params.go:11)	LEAQ	"".oi+24(FP), DI
	0x000e 00014 (explicit-init-return-params.go:11)	XORPS	X0, X0
	0x0011 00017 (explicit-init-return-params.go:11)	ADDQ	$-16, DI
	0x0015 00021 (explicit-init-return-params.go:11)	DUFFZERO	$288
	0x0028 00040 (explicit-init-return-params.go:12)	MOVQ	"".i+8(FP), AX
	0x002d 00045 (explicit-init-return-params.go:12)	CMPQ	AX, $1
	0x0031 00049 (explicit-init-return-params.go:12)	JEQ	$0, 66
	0x0033 00051 (explicit-init-return-params.go:16)	CMPQ	AX, $2
	0x0037 00055 (explicit-init-return-params.go:16)	JEQ	$0, 65
	0x0039 00057 (explicit-init-return-params.go:20)	CMPQ	AX, $3
	0x003d 00061 (explicit-init-return-params.go:20)	JNE	64
	0x003f 00063 (explicit-init-return-params.go:21)	RET
	0x0040 00064 (explicit-init-return-params.go:24)	RET
	0x0041 00065 (explicit-init-return-params.go:17)	RET
	0x0042 00066 (explicit-init-return-params.go:13)	RET
...
"".NamedReturnParamsExplicit·f t=9 dupok size=8
	0x0000 00 00 00 00 00 00 00 00                          ........
	rel 0+8 t=1 "".NamedReturnParamsExplicit+0
